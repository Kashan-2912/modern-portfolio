---
title: "Share Pad: Collaborative Notepad That Lives in the URL"
description: "Share Pad is an ephemeral collaborative notepad with no database and no login. Compress notes into a shareable URL hash, use read-only links, and export to txt, md, or html."
