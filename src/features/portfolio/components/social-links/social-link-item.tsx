    ...
    >
      <div className="relative flex size-12 shrink-0 items-center justify-center">
        {icon ? (
          ...
          <div className="flex size-12 items-center justify-center rounded-xl bg-muted text-lg font-semibold text-muted-foreground corner-squircle supports-corner-shape:rounded-[50%]">
            {title.charAt(0)}
          </div>
        )}
      </div>
